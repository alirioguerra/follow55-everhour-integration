...
export class TimesheetHtmlGenerator {
  ...
  public generateHtml(): string {
    const templateData: TemplateData = {
      ...
      activeTaskHtml: this.generateActiveTaskHtml(),
...
<body>
  ...
  private generateActiveTaskHtml(): string {
    ...
    const timerButton = this.createButton({
      onClick: 'stopTimer()',
    ...
    return `<div class="active-task-container" role="region" aria-label="Active task">
              <div class="active-task-header">ACTIVE TASK</div>
              <div class="active-task">
                  <div class="task-name">${this.escapeHtml(activeTask.name)}</div>
                  <div class="active-task-time" id="active-task-time">
  ...
  private generateWeeklyTaskHtml(task: WeeklyTask): string {
    return `<div class="weekly-task" data-task-id="${task.id}" role="listitem">
  ...
  private getScripts(): string {
    return `const vscode = acquireVsCodeApi();
            ...
            function updateActiveTimer() {
                const activeTaskElement = document.getElementById('active-task-time');
            ...
            document.addEventListener('DOMContentLoaded', updateActiveTimer);`;
  }
}